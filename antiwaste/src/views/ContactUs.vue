    ...
    <v-container fluid>
      <v-row justify="center" align="center" class="contact-us-background">
        <v-col cols="12" md="6" class="text-center">
          ...
          <p class="subheading white--text">We'd love to hear from you. Reach out using the form below or contact us through other means. Feel free to get in touch with us!</p>
        </v-col>
      </v-row>
      ...
      <v-col cols="12" md="6" class="">
        ...
        <v-card>
          ...
          <v-card-text>
            ...
            <h5 class="space"><strong>Address:</strong> 123 Main Street, Cityville, State, Country</h5>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
