<template>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="(message, index) in messages" :key="index">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">{{ message.seller }}</div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">{{ message.amount }}</div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  <div class="mt-2">
                    <form @submit.prevent="updateMessage">
                      ...
                      <div class="mt-4">
                        ...
                        <input v-model="editForm.seller" type="text" class="mt-1 block w-full shadow-sm max-sm:text-sm border-gray-300 rounded-md" />
                      </div>
                      <div class="mt-4">
                        <label for="amount" class="block text-sm font-medium text-gray-700">Amount</label>
                        <input v-model="editForm.amount" type="text" class="mt-1 block w-full shadow-sm max-sm:text-sm border-gray-300 rounded-md" />
                      </div>
                      <div class="mt-4">
  ...
  export default {
    data() {
      return {
        messages: [
          { id: 1, name: "Bottle", categories: "glass", seller: "Jennie", amount: "10kg", price: "20000riel", contact: "098765432", location: "Phnom Penh" },
          { id: 2, name: "Bottle", categories: "glass", seller: "Jennie", amount: "10kg", price: "20000riel", contact: "098765432", location: "Phnom Penh" },
          { id: 3, name: "Bottle", categories: "glass", seller: "Jennie", amount: "10kg", price: "20000riel", contact: "098765432", location: "Phnom Penh" },
          { id: 4, name: "Bottle", categories: "glass", seller: "Jennie", amount: "10kg", price:"20000riel", contact:"098765432", location: "Phnom Penh" },
        ],
        showEditModal: false,
    ...
    methods: {
      editMessage(message) {
        ...
        this.editForm.seller = message.seller;
        this.editForm.amount = message.amount;
        this.editForm.price = message.price;
        this.editForm.contact = message.contact;
